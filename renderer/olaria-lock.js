/**
 * If Game.log identifies the player as player-lock, lock the entire UI.
 */
(function () {
  var locked = false;

  function ensureOverlay() {
    var el = document.getElementById("player-lock-lock");
    if (el) return el;
    el = document.createElement("div");
    el.id = "player-lock-lock";
  ...
  window.checkplayer-lockLock = pollPlayer;
